...
<head>
	...
	<link rel="stylesheet" href="<?php echo content_url('/mu-plugins/include/css/login-eras.css'); ?>">
</head>

<body class="login no-js <?php echo esc_attr( implode( ' ', $classes ) ); ?>">
    <img class="logo-only d-block d-sm-none" src="<?php echo content_url('/mu-plugins/include/image/logo-only.png'); ?>" alt="" srcset="">
	<?php
...
function login_footer( $input_id = '' ) {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Set a timeout to auto-dismiss the notice after 2 seconds
        setTimeout(function() {
...
<form class="admin-email-confirm-form" name="admin-email-confirm-form"
	...
	<h1 class="admin-email__heading text-center">
...
<div class="col lg-6 short-info py-4">
	<div class="col-inner ">
		<div id="logo" class="d-none d-sm-block">
			<img src="<?php echo content_url('/mu-plugins/include/image/logo-eras.webp'); ?>" alt="" srcset="">
		</div>

		<div class="text-white mt-2">
			<p><?php esc_html_e('Technical Support & Web Development: ', 'eras-vietnam'); ?> <br class="d-block d-sm-none"> <a
					href="tel:0988 606 539">0988 606 539</a></p>
			<p>Website: <a href="https://erasvietnam.vn/">www.erasvietnam.vn</a></p>
			<p>Email: <a href="mailto:Support@erasvietnam.vn">Support@erasvietnam.vn</a></p>
		</div>

		<div class="text-white mt-2">
			<p><?php _e('Customer support from Monday to Sunday', 'eras-vietnam'); ?>
				<br class="d-block d-md-none"><?php esc_html_e('(from 8:00 am - 10:00 pm everyday)', 'eras-vietnam'); ?>
			</p>
		</div>

		<div class="mt-2">
			<i> <?php esc_html_e('Note: Customers should not upload plugins', 'eras-vietnam'); ?>
				<br><?php esc_html_e('of unknown origin to the website or interfaces of unknown origin', 'eras-vietnam');?>
				<br><?php esc_html_e('to avoid unwanted malware infection.' , 'eras-vietnam'); ?></i>
		</div>
	</div>
</div>
...
<div class="col lg-6 form-wrapper">
	<div class="col-inner">
		<h1 class="text-center"> <?php esc_html_e('Lost your password?', 'eras-vietnam') ?></h1>
		...
		<form name="lostpasswordform" id="lostpasswordform"
			...
			<p>
				<input type="text" name="user_login" id="user_login" class="input"
					value="<?php echo esc_attr( $user_login ); ?>" size="20" autocapitalize="off" placeholder="<?php esc_html_e('Username or Email Address') ?>"
...
<div class="col lg-6 short-info py-4">
	<div class="col-inner ">
		...
		<div class="text-white mt-2">
			<p><?php esc_html_e('Customer support from Monday to Sunday', 'eras-vietnam'); ?>
            <br class="d-block d-md-none"><?php esc_html_e('(from 8:00 am - 10:00 pm everyday)', 'eras-vietnam'); ?>
			</p>
		</div>
...
<div class="col lg-6 form-wrapper">
	<div class="col-inner">
		<form name="loginform" id="loginform"
			...
			<h1 class="text-center"><?php esc_html_e( 'Log In', 'eras-vietnam' ); ?></h1>
			<p class="text-center mt-3 mb-4">
				<?php esc_html_e( "Don't have an account?", 'eras-vietnam' ); ?>
				<a href="<?php echo esc_url( wp_registration_url() ); ?>" class="text-decoration-none">
					<?php esc_html_e( 'Create Now', 'eras-vietnam' ); ?>
				</a>
			</p>
			<p style="padding: 0 12px;">
				<input placeholder="<?php _e( 'Username or Email Address' ); ?>" type="text" name="log" id="user_login"
					<?php echo $aria_describedby; ?> class="input" value="<?php echo esc_attr( $user_login ); ?>"
					size="20" autocapitalize="off" autocomplete="username" required="required" />
			</p>

			<div style="padding: 0 12px;" class="user-pass-wrap">
				<div class="wp-pwd">
					<input placeholder="<?php _e( 'Password' ); ?>" type="password" name="pwd" id="user_pass"
						<?php echo $aria_describedby; ?> class="input password-input" value="" size="20"
			...
			<div class="row mx-0 justify-content-around align-items-center">
				<p class="col lg-6 forgetmenot"><input name="rememberme" type="checkbox" id="rememberme"
						value="forever" <?php checked( $rememberme ); ?> /> <label
						for="rememberme"><?php esc_html_e( 'Remember Me', 'eras-vietnam' ); ?></label>
				</p>
				<p id="nav" class="col lg-6 mt-0 justify-content-end d-flex align-items-center">
					<?php
			$html_link = sprintf( '<a class="wp-login-lost-password" href="%s">%s</a>', esc_url( wp_lostpassword_url() ), __( 'Lost your password?', 'eras-vietnam' ) );
			...
			<p class="submit d-flex justify-content-center mt-4">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large"
					value="<?php esc_attr_e( 'Log In', 'eras-vietnam' ); ?>" />
				<?php
